...
class ur5e_moveit():
    ...
    def __init__(self):
        ...
        sub_laser = rospy.Subscriber('/sick_safetyscanners/scan', LaserScan, self.sick_scanner)
    ...
    def poz_odlaganje_na_paleto(self, mesto):
        x_r = self.move_group.get_current_pose()
    ...
    def po_izdelek(self):
        ...
        while count_izdelka <= kolicina:
            ...
            if counter < 3:
                ...
                self.poz_umik()
                self.poz_nad_paleto()
                self.poz_odlaganje_na_paleto(count_izdelka)
    ...
    def sick_scanner(self, data):
        neki = rospy.Publisher('/speed_scaling_factor', Float64, queue_size=10)
        neki2 = Float64()
...
if __name__ == '__main__':
    ...
    try:
        ...
        #ur5e_moveit_obj.poz_pred_mlekom()
